...
@prodigy.recipe('textcat.teach-custom-model',
    ...
    goal=("The number of positive examples that you aim to gather", "option", "100", int)
)
def textcat_custom_model(dataset, source, model, label_binarizer, label, goal):
    ...
    model = CustomModel(label=label, model_path=model, label_binarizer_path=label_binarizer)
