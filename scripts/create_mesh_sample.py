...
argparser.add_argument(
    "--mesh_data_path", type=Path, help="path to JSONL of processed mesh data"
)
argparser.add_argument(
    "--sample_mesh_data_path",
    type=Path,
    help="path to output sample JSONL of mesh data",
)
argparser.add_argument(
    "--mti_input_path",
    type=Path,
    default=None,
    help="path to output txt for MTI to use an input",
)
